...
images: [
    "/images/posts/your-database-connection-deserves-a-name/assign-a-name-to-your-connection.png",
    "/images/posts/your-database-connection-deserves-a-name/perfect-engineering-world-vs-reality-shared-database.png"
]
categories: [
    "Engineering",
    "Lessons learned"
...
<BlogPostImage
    path="/images/posts/your-database-connection-deserves-a-name/assign-a-name-to-your-connection.png"
...
<Figure
    path="/images/posts/your-database-connection-deserves-a-name/perfect-engineering-world-vs-reality-shared-database.png"
...
<Figure
    path="/images/posts/your-database-connection-deserves-a-name/mongodb-db.currentOp-result.png"
...
<Figure
    path="/images/posts/your-database-connection-deserves-a-name/rabbitmq-connection-client-name.png"
