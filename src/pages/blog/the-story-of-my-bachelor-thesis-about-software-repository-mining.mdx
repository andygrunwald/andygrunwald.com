...
* [Analysis of Signature Change Patterns](https://users.soe.ucsc.edu/~ejw/papers/kim-MSR2005.pdf "Paper Analysis of Signature Change Patterns")
...
At [1st & 2nd February 2014 the FOSDEM event](https://archive.fosdem.org/2014/ "FOSDEM 2014") retakes places in Brussels, Belgium.
...
- concepts with new tools (TYPO3-Analytics, [RabbitMQ](https://www.rabbitmq.com/ "Message queue system RabbitMQ"), [supervisord](https://github.com/Supervisor/supervisor "Software supervisord"), [Vagrant](https://www.vagrantup.com/ "Software Vagrant"), [Chef](https://www.chef.io/products/chef-infra "Software Chef")...)
