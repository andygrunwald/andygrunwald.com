...
description: "We have run the Web Engineering Düsseldorf Meetup since 2012. Feedback from attendees is vital to us our improvement. Here are the results from the feedback wall during the Web Engineering Düsseldorf May Meetup."
images: [
    "../../assets/images/posts/webengdus-feedback-wall-2018-05/web-engineering-duesseldorf-logo-banner.png"
]
categories: [
    "Meetups"
]
...
import imgWebEngineeringDuesseldorfLogoBanner from "../../assets/images/posts/webengdus-feedback-wall-2018-05/web-engineering-duesseldorf-logo-banner.png";
