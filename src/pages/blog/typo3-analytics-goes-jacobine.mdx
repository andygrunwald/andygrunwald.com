...
description: "The open-source project 'TYPO3-Analytics' was looking for a new name. This blog post is about how we found the new name Jacobine for the open-source project TYPO3-Analytics."
images: []
