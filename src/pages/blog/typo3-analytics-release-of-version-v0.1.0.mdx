...
description: "A new version of the open-source project TYPO3-Analytics (now Jacobine) is out. We released version 0.1.0. We summarize the main changes and provide an outlook for the future."
images: []
...
* *testing*: **Unit tests** were introduced in this release. The **code coverage** is not very high (**18%**), but 18% are better than nothing! **[TravisCI](https://www.travis-ci.com/ "TravisCI")** was introduced to check the **success** of the unit tests **continuously**.
...
If you are interested, just contact me via Twitter ([@andygrunwald](https://twitter.com/andygrunwald "Andy Grunwald at twitter")) or by email ([GitHub profile](https://github.com/andygrunwald "Andy Grunwald at GitHub")).