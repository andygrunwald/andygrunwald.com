...
description: "We built our own game show buzzers and played the popular quiz show Jeopardy! with our friends. Here we describe how you can do this as well."
images: [
    "../../assets/images/posts/things-with-buzzers-playing-jeopardy/jeopardy-game-show-board.png",
    "../../assets/images/posts/things-with-buzzers-playing-jeopardy/architecture-raspberry-pi-websocket-usb-game-show-buzzer-setup-frontend.png",
    "../../assets/images/posts/things-with-buzzers-playing-jeopardy/playing-jeopardy-game-show-buzzer-trivago-tech-get-together-2019.jpg"
]
categories: [
    "Community",
    "things with buzzers"
...
import imgJeopardyGameShowBoard from "../../assets/images/posts/things-with-buzzers-playing-jeopardy/jeopardy-game-show-board.png";
import imgArchitectureRaspberryPiWebsocketUsbGameShowBuzzerSetupFrontend from "../../assets/images/posts/things-with-buzzers-playing-jeopardy/architecture-raspberry-pi-websocket-usb-game-show-buzzer-setup-frontend.png";
import imgPlayingJeopardyGameShowBuzzerTrivagoTechGetTogether2019 from "../../assets/images/posts/things-with-buzzers-playing-jeopardy/playing-jeopardy-game-show-buzzer-trivago-tech-get-together-2019.jpg";
...
<Figure
    src={imgJeopardyGameShowBoard}
    alt="things with buzzers: The Jeopardy! game board."
    title="things with buzzers: The Jeopardy! game board." />

<UpdateBox>
    If you like this article, you might want to read [things with buzzers: building them](/blog/things-with-buzzers-building-your-own-game-show-buzzers/ "things with buzzers: building your own game-show buzzers") and [things with buzzers: a sports competition](/blog/things-with-buzzers-a-sports-competition/ "Running a local fitness competition with self-made game show buzzers") as well.
</UpdateBox>
...
A quick [_Jeopardy_ search on GitHub](https://github.com/search?q=jeopardy "Jeopardy search on GitHub") revealed many repositories containing this game already.
I love open source!
...
<Figure
    src={imgPlayingJeopardyGameShowBuzzerTrivagoTechGetTogether2019}
    ...
    title="Playing a Jeopardy! game at trivago's internal tech conference on the 19th of March 2019 with our self-made game show buzzers." />

<YouTube id="-be2fD5neGU" description="The official event video from trivago. The Jeopardy! game is visible from 0:59 min to 1:04 min." />
