...
Four software projects have been listed: [OpenBSD](#openbsd), [TropicSSL](#tropicssl), [Flexible and Economical UTF-8 Decoder](#flexible-and-economical-utf-8-decoder), and [the WIDE project](#the-wide-project).
...
The company behind PolarSSL was [aquired by ARM](https://www.securityweek.com/polarssl-rebranded-arm-mbed-tls-after-acquisition), and the product was renamed to [mbedTLS](https://www.trustedfirmware.org/projects/mbed-tls/).
mbedTLS is still available and [activily maintained at GitHub](https://github.com/Mbed-TLS/mbedtls).
