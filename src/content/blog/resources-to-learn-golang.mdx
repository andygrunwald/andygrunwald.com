...
For some time, I am fascinated by the [go programing language](https://go.dev/ "Go(lang) programing language") launched by Google in 2009.
...
1. The [A Tour of Go](https://go.dev/tour/ "Official A Tour of Go") is the best start. It provides an overview of the syntax and the features in a concise way.
...
3. The guide for golang: [Effective Go](https://go.dev/doc/effective_go "Official Effective Go Guide"). It describes all features with backgrounds and examples.
...
I recommend starting with it after you finished the [A Tour of Go](https://go.dev/tour/ "Official A Tour of Go") and during reading [Go in Action](https://www.goinactionbook.com/ "Go in Action Book").
