...
images: [
    "/src/assets/images/posts/your-database-connection-deserves-a-name/assign-a-name-to-your-connection.png",
    "/src/assets/images/posts/your-database-connection-deserves-a-name/perfect-engineering-world-vs-reality-shared-database.png"
]
categories: [
    "Engineering",
    "Lessons learned"
...
<BlogPostImage
    path="/src/assets/images/posts/your-database-connection-deserves-a-name/assign-a-name-to-your-connection.png"
...
<Figure
    path="/src/assets/images/posts/your-database-connection-deserves-a-name/perfect-engineering-world-vs-reality-shared-database.png"
...
<Figure
    path="/src/assets/images/posts/your-database-connection-deserves-a-name/mongodb-db.currentOp-result.png"
...
<Figure
    path="/src/assets/images/posts/your-database-connection-deserves-a-name/rabbitmq-connection-client-name.png"
