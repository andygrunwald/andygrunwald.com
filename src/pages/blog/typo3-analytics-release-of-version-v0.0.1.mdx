...
description: "A new version of the open-source project TYPO3-Analytics (now Jacobine) is out. We released version 0.0.1. We summarize the main changes and provide an outlook for the future."
images: []
...
If you want to contribute and you do not know how to contact me via Twitter ([@andygrunwald](https://twitter.com/andygrunwald "Andy Grunwald at twitter")) or by email ([GitHub profile](https://github.com/andygrunwald "Andy Grunwald at GitHub")).