...
images: [
    "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-game-rules.png",
    "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-group-game-play.png",
    "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-group-seating-area.png",
    "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-collage.png",
]
categories: [
    "Community",
    "Lessons learned"
...
import imgRockPaperScissorsGameRules from "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-game-rules.png";
import imgRockPaperScissorsGroupGamePlay from "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-group-game-play.png";
import imgRockPaperScissorsGroupSeatingArea from "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-group-seating-area.png";
import imgRockPaperScissorsCollage from "../../assets/images/posts/playing-rock-paper-scissors-with-500-people/rock-paper-scissors-collage.png";

<BlogPostImage
    src={imgRockPaperScissorsGameRules}
...
<Figure
    src={imgRockPaperScissorsGroupGamePlay}
...
<Figure
    src={imgRockPaperScissorsGroupSeatingArea}
...
<Figure
    src={imgRockPaperScissorsCollage}
...
- Thanks to [Cristiano Zoucas](https://thenounproject.com/cristiano.zoucas/ "Cristiano Zoucas at The Noun Project") for the icons [Fist](https://thenounproject.com/icon/fist-477918/ "Fist-Icon at The Noun Project"), [Hand](https://thenounproject.com/icon/hand-477922/ "Hand-Icon at The Noun Project") and [Scissors](https://thenounproject.com/icon/scissors-477919/ "Scissors-Icon at The Noun Project")
- Thanks to [Danil Polshin](https://thenounproject.com/everydaytemplate/ "Danil Polshin at The Noun Project") for his People2 collection.