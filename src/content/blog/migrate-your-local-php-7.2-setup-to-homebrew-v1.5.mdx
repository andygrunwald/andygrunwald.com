...
description: "Homebrew v1.5 changed the way how the PHP programming language packages are installed. This blog post is a small guide on how you migrate your local Homebrew PHP setup while updating to Homebrew v1.5."
images: []
categories: [
    "PHP",
    "Open Source",
...
If you encounter any problems, check the [Troubleshooting](#troubleshooting "Troubleshooting your PHP Homebrew setup") section
below.
