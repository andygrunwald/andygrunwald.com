...
images: [
    "../../assets/images/posts/your-database-connection-deserves-a-name/assign-a-name-to-your-connection.png",
    "../../assets/images/posts/your-database-connection-deserves-a-name/perfect-engineering-world-vs-reality-shared-database.png"
]
categories: [
    "Engineering",
    "Lessons learned"
...
import imgAssignANameToYourConnection from "../../assets/images/posts/your-database-connection-deserves-a-name/assign-a-name-to-your-connection.png";
import imgPerfectEngineeringWorldVsRealitySharedDatabase from "../../assets/images/posts/your-database-connection-deserves-a-name/perfect-engineering-world-vs-reality-shared-database.png";
import imgMongodbDbCurrentOpResult from "../../assets/images/posts/your-database-connection-deserves-a-name/mongodb-db.currentOp-result.png";
import imgRabbitmqConnectionClientName from "../../assets/images/posts/your-database-connection-deserves-a-name/rabbitmq-connection-client-name.png";

<BlogPostImage
    src={imgAssignANameToYourConnection}
    alt="Provide a name to your database connection"
    title="Provide a name to your database connection" />
...
[MongoDB](#how-to-assign-a-name-to-your-mongodb-connection), 
[MSSQL / SQL-Server](#how-to-assign-a-name-to-your-mssql--sql-server-connection), 
[MySQL](#how-to-assign-a-name-to-your-mysql-connection), 
[NATS](#how-to-assign-a-name-to-your-nats-connection), 
[Oracle database](#how-to-assign-a-name-to-your-oracle-connection), 
[PostgreSQL](#how-to-assign-a-name-to-your-postgresql-connection), 
[redis](#how-to-assign-a-name-to-your-redis-connection), 
and non-database systems like [RabbitMQ](#how-to-assign-a-name-to-your-rabbitmq-connection) or 
...
<Figure
    src={imgPerfectEngineeringWorldVsRealitySharedDatabase}
    alt="A perfect world where everyone has its own database vs. Reality where databases are shared."
    title="A perfect world where everyone has its own database vs. Reality where databases are shared." />
...
<Figure
    src={imgMongodbDbCurrentOpResult}
    alt="MongoDB: Output of db.currentOp() including the `appName` setting"
    title="MongoDB: Output of db.currentOp() including the `appName` setting" />
...
While creating a [connection to SQL-Server, you can set an `Application Name`](https://learn.microsoft.com/en-us/dotnet/api/system.data.sqlclient.sqlconnection.connectionstring?view=dotnet-plat-ext-5.0).
...
While creating a connection to [NATS](https://nats.io/), you can provide [client connection name](https://docs.nats.io/using-nats/developer/connecting/name "Connection Name @ NATS docs").
...
<Figure
    src={imgRabbitmqConnectionClientName}
    alt="RabbitMQ Connections: Showing clients name under the IP address"
    title="RabbitMQ Connections: Showing clients name under the IP address" />
