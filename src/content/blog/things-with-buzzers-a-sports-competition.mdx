...
description: "We built our own game show buzzers and organized a fitness sports competition. The athlete pushed the buzzer at the finish to track his time. Here we describe how you can do this as well."
images: [
    "../../assets/images/posts/things-with-buzzers-sports-competition/things-with-buzzers-sports-competition-interface.png",
    "../../assets/images/posts/things-with-buzzers-sports-competition/architecture-raspberry-pi-websocket-usb-game-show-buzzer-setup-frontend.png",
    "../../assets/images/posts/things-with-buzzers-sports-competition/installation-of-self-made-game-show-buzzer.jpg",
    "../../assets/images/posts/things-with-buzzers-sports-competition/final-game-show-buzzer-event-setup.jpg",
    "../../assets/images/posts/things-with-buzzers-sports-competition/scoreboard-during-rowing-exercise.jpg",
    "../../assets/images/posts/things-with-buzzers-sports-competition/scoreboard-during-wallballs-exercise.jpg"
]
categories: [
    "Community",
    "things with buzzers"
...
import imgThingsWithBuzzersSportsCompetitionInterface from "../../assets/images/posts/things-with-buzzers-sports-competition/things-with-buzzers-sports-competition-interface.png";
import imgArchitectureRaspberryPiWebsocketUsbGameShowBuzzerSetupFrontend from "../../assets/images/posts/things-with-buzzers-sports-competition/architecture-raspberry-pi-websocket-usb-game-show-buzzer-setup-frontend.png";
import imgInstallationOfSelfMadeGameShowBuzzer from "../../assets/images/posts/things-with-buzzers-sports-competition/installation-of-self-made-game-show-buzzer.jpg";
import imgFinalGameShowBuzzerEventSetup from "../../assets/images/posts/things-with-buzzers-sports-competition/final-game-show-buzzer-event-setup.jpg";
import imgScoreboardDuringRowingExercise from "../../assets/images/posts/things-with-buzzers-sports-competition/scoreboard-during-rowing-exercise.jpg";
import imgScoreboardDuringWallballsExercise from "../../assets/images/posts/things-with-buzzers-sports-competition/scoreboard-during-wallballs-exercise.jpg";
...
<Figure
    src={imgThingsWithBuzzersSportsCompetitionInterface}
...
<Figure
    src={imgArchitectureRaspberryPiWebsocketUsbGameShowBuzzerSetupFrontend}
