...
description: "I have been running a local meetup group for over four years. Here, I am summarizing and sharing lessons learned from running a local user group/meetup with you so that you can avoid the same mistakes."
images: [
	"../../assets/images/posts/lesson-learned-from-running-a-meetup/php-usergroup-duesseldorf-meetup-october-2013-tobias-schlitt.jpeg",
    "../../assets/images/posts/lesson-learned-from-running-a-meetup/web-engineering-duesseldorf-meetup-july-2016-full-room-people.jpeg",
	"../../assets/images/posts/lesson-learned-from-running-a-meetup/web-engineering-duesseldorf-meetup-july-2016-prepared-room.jpeg",
	"../../assets/images/posts/lesson-learned-from-running-a-meetup/web-engineering-duesseldorf-meetup-june-2016-matthias-endler.jpeg"
]
categories: [
    "Lessons learned",
    "Meetups"
...
import imgPhpUsergroupDuesseldorfMeetupOctober2013TobiasSchlitt from "../../assets/images/posts/lesson-learned-from-running-a-meetup/php-usergroup-duesseldorf-meetup-october-2013-tobias-schlitt.jpeg";
import imgWebEngineeringDuesseldorfMeetupJuly2016FullRoomPeople from "../../assets/images/posts/lesson-learned-from-running-a-meetup/web-engineering-duesseldorf-meetup-july-2016-full-room-people.jpeg";
import imgWebEngineeringDuesseldorfMeetupJuly2016PreparedRoom from "../../assets/images/posts/lesson-learned-from-running-a-meetup/web-engineering-duesseldorf-meetup-july-2016-prepared-room.jpeg";
import imgWebEngineeringDuesseldorfMeetupJune2016MatthiasEndler from "../../assets/images/posts/lesson-learned-from-running-a-meetup/web-engineering-duesseldorf-meetup-june-2016-matthias-endler.jpeg";

<BlogPostImage
    src={imgPhpUsergroupDuesseldorfMeetupOctober2013TobiasSchlitt}
    alt="Tobias Schlitt at the PHP Usergroup Meetup in October 2013"
    title="Tobias Schlitt at the PHP Usergroup Meetup in October 2013" />
...
1. They register and start a meetup.
2. They add a first meetup date without a location and a topic (everything marked as TBD).
3. The first people join the group.
4. If you are lucky, the first meetup takes place, but this is often the last one.
If you are unlucky, the first meetup will be canceled due to no location or topic.
5. A new meetup cadaver was created (sorry to be so harsh, but this is often the truth).
...
<Figure
    src={imgWebEngineeringDuesseldorfMeetupJuly2016FullRoomPeople}
    alt="Full room for the Web Engineering Meetup Düsseldorf July 2016 Event"
    title="Full room for the Web Engineering Meetup Düsseldorf July 2016 Event" />
...
Some other meetups choose Twitter or [XING](https://www.xing.com/ "XING") as the platform (like the Düsseldorfer Java User Group).
...
<Figure
    src={imgWebEngineeringDuesseldorfMeetupJuly2016PreparedRoom}
    alt="Prepared room for the Web Engineering Meetup Düsseldorf July 2016 Event"
    title="Prepared room for the Web Engineering Meetup Düsseldorf July 2016 Event" />
...
<Figure
    src={imgWebEngineeringDuesseldorfMeetupJune2016MatthiasEndler}
    alt="Matthias Endler during the Web Engineering Düsseldorf Meetup in June 2016 at trivago"
    title="Matthias Endler during the Web Engineering Düsseldorf Meetup in June 2016 at trivago" />
...
* [GitHub](https://github.com/orgs/community/discussions/ "GitHub")
